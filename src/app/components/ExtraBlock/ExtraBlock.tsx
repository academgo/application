...
const ExtraBlock: FC<Props> = ({ extraBlock }) => {
  return (
    <section className={styles.extraBlock}>
      <div className="container">
        <div className={styles.extra}>
          <Image
            alt={extraBlock.title}
            src={urlFor(extraBlock.bgImage).url()}
            fill={true}
          ...
          <div className={styles.extraWrapper}>
            ...
            <div className={styles.asideContent}>
              {extraBlock.asideContent.map(item => (
                <p key={item._key} className={styles.asideItem}>
                  {item.title}
                </p>
              ))}
            </div>
