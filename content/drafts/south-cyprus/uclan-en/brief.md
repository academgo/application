# Brief: UCLan Cyprus university card (EN)

- **URL:** `/study-in-cyprus/uclan-cyprus`
...
- **Fact sheets:** `content/facts/scyprus-uclan.md` (university) + `content/facts/south-cyprus.md` (country: visa, documents, living). Do not read other drafts.

## Keywords

uclan cyprus — 18 100 / IN 1 300 / PK 880
...
5. **video slot:** "UCLan Cyprus campus walkthrough", 60–90 sec.
...
14. **cta** — we check your documents against UCLan Cyprus's requirements and compare 2–3 alternatives.
