# Brief: UCSI University university card (EN)

- **URL:** `/study-in-malaysia/ucsi-university`
- **Type:** university-card
- **Audience:** applicants and parents from Pakistan, India, Bangladesh, Nigeria, Egypt, and GCC expat families.
- **Fact sheets:** `content/facts/malaysia-ucsi.md` (university) + `content/facts/malaysia.md` (country: visa, documents, living). Do not read other drafts.

## Keywords

ucsi university — 49 500 / IN 1 600 / PK 590
...
5. **video slot:** "UCSI University campus walkthrough", 60–90 sec.
...
14. **cta** — we check your documents against UCSI University's requirements and compare 2–3 alternatives.
