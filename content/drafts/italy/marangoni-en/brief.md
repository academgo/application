# Brief: Istituto Marangoni university card (EN)

- **URL:** `/study-in-italy/istituto-marangoni`
- **Type:** university-card
- **Audience:** applicants and parents from Pakistan (large demand), India, Nigeria, Bangladesh, Egypt, GCC.
- **Fact sheets:** `content/facts/italy-marangoni.md` (university) + `content/facts/italy.md` (country: visa, documents, living). Do not read other drafts.

## Keywords

istituto marangoni — 49 500 / IN 4 400
...
5. **video slot:** "Istituto Marangoni campus walkthrough", 60–90 sec.
...
14. **cta** — we check your documents against Istituto Marangoni's requirements and compare 2–3 alternatives.
