# Brief: Bocconi University university card (EN)

- **URL:** `/study-in-italy/bocconi-university`
- **Type:** university-card
- **Audience:** applicants and parents from Pakistan (large demand), India, Nigeria, Bangladesh, Egypt, GCC.
- **Fact sheets:** `content/facts/italy-bocconi.md` (university) + `content/facts/italy.md` (country: visa, documents, living). Do not read other drafts.

## Keywords

bocconi university — 74 000 / IN 8 100 / PK 1 600
...
5. **video slot:** "Bocconi University campus walkthrough", 60–90 sec.
...
14. **cta** — we check your documents against Bocconi University's requirements and compare 2–3 alternatives.
