# Бриф: карточка Cyprus International University (CIU) (RU)
...
- **Сводки фактов:** `content/facts/ncyprus-ciu.md` (вуз) + `content/facts/north-cyprus.md`, `content/facts/north-cyprus-recognition.md` (страна: виза, документы, жизнь). Других черновиков не читать.

## Ключевые слова

ciu cyprus — 10; кипрский международный университет — KZ 20. RU-аудитория ищет вуз латиницей: название латиницей — в H1, meta title и первом абзаце.
...
5. **video slot:** «Кампус Cyprus International University (CIU)», 60–90 сек.
...
14. **cta** — проверим документы под требования Cyprus International University (CIU) и сравним с 2–3 альтернативами.
