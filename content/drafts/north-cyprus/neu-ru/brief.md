# Бриф: карточка Near East University (NEU) (RU)
...
- **Сводки фактов:** `content/facts/ncyprus-neu.md` (вуз) + `content/facts/north-cyprus.md`, `content/facts/north-cyprus-recognition.md` (страна: виза, документы, жизнь). Других черновиков не читать.

## Ключевые слова

neu cyprus — 10; ближневосточный университет — 10. RU-аудитория ищет вуз латиницей: название латиницей — в H1, meta title и первом абзаце.
...
5. **video slot:** «Кампус Near East University (NEU)», 60–90 сек.
...
14. **cta** — проверим документы под требования Near East University (NEU) и сравним с 2–3 альтернативами.
