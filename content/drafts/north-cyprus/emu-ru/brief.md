# Бриф: карточка Eastern Mediterranean University (EMU) (RU)
...
- **Сводки фактов:** `content/facts/ncyprus-emu.md` (вуз) + `content/facts/north-cyprus.md`, `content/facts/north-cyprus-recognition.md` (страна: виза, документы, жизнь). Других черновиков не читать.

## Ключевые слова

emu cyprus — KZ 30; восточно-средиземноморский университет — 10. RU-аудитория ищет вуз латиницей: название латиницей — в H1, meta title и первом абзаце.
...
5. **video slot:** «Кампус Eastern Mediterranean University (EMU)», 60–90 сек.
...
14. **cta** — проверим документы под требования Eastern Mediterranean University (EMU) и сравним с 2–3 альтернативами.
