# Бриф: «Поступление в вузы Северного Кипра» (RU)
...
- **Содержание:** требования (аттестат, английский, без экзаменов), документы и апостиль, наборы, подготовительный английский, как выбрать вуз и программу с учётом признания.
- **Сводки фактов:** `content/facts/north-cyprus.md`, `content/facts/north-cyprus-recognition.md`, `content/facts/ncyprus-ciu.md`, `content/facts/ncyprus-neu.md`, `content/facts/ncyprus-gau.md`, `content/facts/ncyprus-emu.md`, `content/facts/ncyprus-metu-ncc.md`. Других черновиков не читать.
...
университеты северного кипра (KZ 20); учеба на северном кипре
