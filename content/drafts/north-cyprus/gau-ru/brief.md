# Бриф: карточка Girne American University (GAU) (RU)
...
- **Сводки фактов:** `content/facts/ncyprus-gau.md` (вуз) + `content/facts/north-cyprus.md`, `content/facts/north-cyprus-recognition.md` (страна: виза, документы, жизнь). Других черновиков не читать.

## Ключевые слова

girne american university — KZ 90 / AZ 70. RU-аудитория ищет вуз латиницей: название латиницей — в H1, meta title и первом абзаце.
...
5. **video slot:** «Кампус Girne American University (GAU)», 60–90 сек.
...
14. **cta** — проверим документы под требования Girne American University (GAU) и сравним с 2–3 альтернативами.
