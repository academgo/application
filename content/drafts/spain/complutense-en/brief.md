# Brief: Universidad Complutense de Madrid university card (EN)

- **URL:** `/study-in-spain/complutense-university-of-madrid`
...
- **Fact sheets:** `content/facts/spain-complutense.md` (university) + `content/facts/spain.md` (country: visa, documents, living). Do not read other drafts.

## Keywords

universidad complutense de madrid — 135 000 (в основном Испания)
...
5. **video slot:** "Universidad Complutense de Madrid campus walkthrough", 60–90 sec.
...
14. **cta** — we check your documents against Universidad Complutense de Madrid's requirements and compare 2–3 alternatives.
