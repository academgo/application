# Brief: Universitat de Barcelona university card (EN)

- **URL:** `/study-in-spain/university-of-barcelona`
...
- **Fact sheets:** `content/facts/spain-barcelona.md` (university) + `content/facts/spain.md` (country: visa, documents, living). Do not read other drafts.

## Keywords

university of barcelona — 33 100 / IN 2 900 / PK 1 300 / NG 720
...
5. **video slot:** "Universitat de Barcelona campus walkthrough", 60–90 sec.
...
14. **cta** — we check your documents against Universitat de Barcelona's requirements and compare 2–3 alternatives.
