# Brief: UCAM — Universidad Católica de Murcia university card (EN)

- **URL:** `/study-in-spain/ucam`
...
- **Fact sheets:** `content/facts/spain-ucam.md` (university) + `content/facts/spain.md` (country: visa, documents, living). Do not read other drafts.

## Keywords

ucam — 135 000 (в основном Испания) / IN 1 000
...
5. **video slot:** "UCAM — Universidad Católica de Murcia campus walkthrough", 60–90 sec.
...
14. **cta** — we check your documents against UCAM — Universidad Católica de Murcia's requirements and compare 2–3 alternatives.
