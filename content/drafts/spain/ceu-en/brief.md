# Brief: Universidad CEU San Pablo university card (EN)

- **URL:** `/study-in-spain/ceu-san-pablo-university`
...
- **Fact sheets:** `content/facts/spain-ceu.md` (university) + `content/facts/spain.md` (country: visa, documents, living). Do not read other drafts.

## Keywords

ceu san pablo university — 1 300
...
5. **video slot:** "Universidad CEU San Pablo campus walkthrough", 60–90 sec.
...
14. **cta** — we check your documents against Universidad CEU San Pablo's requirements and compare 2–3 alternatives.
